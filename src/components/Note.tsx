...
const Note: React.FC<NoteProps> = ({value, id}) => {
    ...
    return (
        <div className="bg-white border-2 rounded-md border-gray-300 pl-5 m-2 h-20 overflow-clip flex gap-2">
            <textarea name="textarea" value={value} className="grow block text-md text-gray-700 tracking-tight font-semibold truncate resize-none whitespace-pre-line outline-none h-full mt-3 disabled:bg-white" maxLength={128}/>
