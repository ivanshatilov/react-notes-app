...
const Note: React.FC<NoteProps> = ({value, id, date, confirmed, editable}) => {
    ...
    return (
        <div className={`border-2 rounded-md border-gray-300 pl-5 m-2 h-24 overflow-clip flex gap-0 ${confirmed && "bg-green-100 border-green-300"} ${editable && "bg-yellow-100 border-yellow-200"}`}>
