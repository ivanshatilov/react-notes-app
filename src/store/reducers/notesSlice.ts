...
const initialState: NotesState = {
    ...
    notes: [
        {id: '1', body: 'take out the trash and clean up the house', date: "17:20:2001", confirmed: false},
        {id: '2', body: 'go to a meeting in the park at 17 pm', date: "17:20:2001", confirmed: false},
        {id: '3', body: 'finish reading the book', date: "17:20:2001", confirmed: false},
...
export const notesSlice = createSlice({
    ...
    initialState,
    reducers: {
        addNote(state, action: PayloadAction<{id: string, body: string, date: string, confirmed: boolean}>) {
